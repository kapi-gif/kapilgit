...
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">Home</li>
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">About</li>
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">Team</li>
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">Process</li>
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">Pricing</li>
//             <li className="hover:bg-gray-600 px-2 py-2 rounded">Blog</li>
//           </div>
//           <button className="bg-lime-200 text-black px-4 py-2 rounded-md hover:bg-blue-600">
//             Contact Us
//           </button>
//         </ul>
//       </nav>
...
//       <div className='px-16 bg-lime-50 m-10 h-96'>
//       <div className='py-8 px-5 font-bold text-center text-xl '>Welcome to Nutritionist</div>
...
//               src={about1}
//               alt="about1"
//               className="rounded-lg shadow-md w-full object-cover h-72 -ml-10"
//             />
//           </div>
...
//         <div className="grid grid-cols-1 divide-x md:grid-cols-2 items-center">
//           {/* Image Section */}
//           <div className="w-full">
//             <img
//               src={about9}
...
//     <div className='bg-lime-50 ml-10 w-5/12 h-28'>
//         <h3 className='px-3 py-4 ml-5'>10,000+ Transformations</h3>
...
//          <div className='bg-lime-50 -mt-32 mr-10 ml-10 w-5/12 h-28 float-right ...'>
//         <h3 className='px-3 py-4 ml-5'>Recognition for Excellence</h3>
...
//          <div className='bg-lime-50 ml-10 w-5/12 h-28'>
//         <h3 className='px-3 py-4 ml-5'>Positive Client Reviews</h3>
...
//          <div className='bg-lime-50 -mt-28 mr-10 ml-10 w-5/12 h-28 float-right ...'>
//         <h3 className='px-3 py-4 ml-5'>Collaborate With Top Health Experts</h3>
...
//         <button className='bg-lime-200 px-3 py-2 rounded mr-5 float-right ...'>Book a Demo</button>
